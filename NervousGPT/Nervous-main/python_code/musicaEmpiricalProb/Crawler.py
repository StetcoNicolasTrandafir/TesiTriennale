...
#per ogni genere musicale, fa scrapring di diverse canzoni di cui salva in data.txt titolo, autore, genere e attributi. 
# e.g. {"title": "Idalah-Abal",
...
#da capire cos'è il numero di fianco ad ogni attributo